...
diet = read.delim('../diet_pe_concentrations.csv', stringsAsFactors = F, sep = ',')
...
pdf('Distribution_of_PE_class_DIET_INDIVID.pdf', w = 14, h = 5)
...
# pdf('Distribution_of_PE_class_DIET_INDIVID_KO.pdf', w = 6, h = 3.5)
# par(mar = c(4,4,4,6), mgp = c(3,1,0), mfrow=c(1,1))
...
# pdf('Distribution_of_PE_class_DIET_INDIVID_KOS.pdf', w = 6, h = 3.5)
# par(mar = c(4,4,4,6), mgp = c(3,1,0), mfrow=c(1,1)) 
...
pdf('Distribution_of_PE_class_DIET_OVERLAY.pdf', w = 12, h = 2.5)
# par(mar = c(4,4,4,6), mgp = c(3,1,0), mfrow=c(1,1)) 
...
### INDIVIDUAL PLOT - Plasmalogen PE class
pdf('Distribution_of_PE_class_Plasmalogen_DIET_INDIVID.pdf', w = 14, h = 5)
# par(mar = c(4,4,4,6), mgp = c(3,1,0), mfrow=c(1,1)) 
par(mar = c(4,4,4,7), mgp = c(3,1,0), mfrow=c(2,3)) 
...
# pdf('Distribution_of_PE_class_Plasmalogen_DIET_INDIVID_KO.pdf', w = 6, h = 3.5)
# par(mar = c(4,4,4,6), mgp = c(3,1,0), mfrow=c(1,1)) 
plot(diet$length, diet$dbonds, cex = diet$av.ko1*0.4+0.6, col = '#663333', bg = alpha('#663333', 0.5), pch = 21,
     main = '', ylab = 'Double bonds', xlab = 'Carbon chain length', 
     yaxt = 'n', xaxt = 'n')
...
# pdf('Distribution_of_PE_class_Plasmalogen_DIET_INDIVID_KOS.pdf', w = 6, h = 3.5)
# par(mar = c(4,4,4,6), mgp = c(3,1,0), mfrow=c(1,1)) 
plot(diet$length, diet$dbonds, cex = diet$av.ko2*0.4+0.6, col = '#065c69', bg = alpha('#065c69', 0.5), pch = 21,
     main = '', ylab = 'Double bonds', xlab = 'Carbon chain length', 
     yaxt = 'n', xaxt = 'n')
...
### OVERLAY PLOT - Plasmalogen PE class
pdf('Distribution_of_PE_class_Plasmalogen_DIET_OVERLAY.pdf', w = 12, h = 2.5)
# par(mar = c(4,4,4,6), mgp = c(3,1,0), mfrow=c(1,1)) 
par(mar = c(4,4,4,7), mgp = c(3,1,0), mfrow=c(1,3)) 
