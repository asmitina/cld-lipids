...
diet = read.delim('../diet_aav_cer_concentrations.csv', stringsAsFactors = F, sep = ',')
...
diet$fas = sapply(strsplit(diet$fas, '\\)'), '[', 1)      

diet$fa1 = sapply(strsplit(diet$fas, '/'), '[', 1) 
diet$fa1 = gsub('d', '', diet$fa1)                       
...
### INDIVIDUAL PLOT - CER class
pdf('Distribution_of_CER_class_DIET_AAV_INDIVID.pdf', w = 14, h = 5)
# par(mar = c(4,4,4,6), mgp = c(3,1,0), mfrow=c(1,1)) 
par(mar = c(4,4,4,7), mgp = c(3,1,0), mfrow=c(2,3)) 

plot(diet$length, diet$dbonds, cex = diet$av.wt*5+0.6, col = '#b4b4b4', bg = alpha('#b4b4b4', 0.5), pch = 21,
     main = '', ylab = 'Double bonds', xlab = 'Carbon chain length',
     yaxt = 'n', xaxt = 'n', ylim = c(0.5,3.5), xlim = c(33.5, 43.5))
...
legend('topright', legend = c('0.01','0.1',' 0.5'),col='#b4b4b4',pt.bg = alpha('#b4b4b4', 0.5),
       pch=21,pt.cex=c(0.01,0.1,0.5)*5+0.6,cex = 0.8,title = 'Concentration', xpd = TRUE, inset = c(-0.25,0), bty = 'n')
# dev.off()
range(diet$av.wt)

# pdf('Distribution_of_CER_class_DIET_AAV_INDIVID_KO.pdf', w = 6, h = 3.5)
# par(mar = c(4,4,4,6), mgp = c(3,1,0), mfrow=c(1,1)) 
plot(diet$length, diet$dbonds, cex = diet$av.ko1*5+0.6, col = '#663333', bg = alpha('#663333', 0.5), pch = 21,
     main = '', ylab = 'Double bonds', xlab = 'Carbon chain length', 
     yaxt = 'n', xaxt = 'n', ylim = c(0.5,3.5), xlim = c(33.5, 43.5))
...
axis(1, seq(30,50,1))
axis(2,seq(0,6,1), las = 2)
legend('topright', legend = c('0.01','0.1',' 0.5'),col='#663333',pt.bg = alpha('#663333', 0.5),
       pch=21,pt.cex=c(0.01,0.1,0.5)*5+0.6,cex = 0.8,title = 'Concentration', xpd = TRUE, inset = c(-0.25,0), bty = 'n')
# dev.off()


# pdf('Distribution_of_CER_class_DIET_AAV_INDIVID_KOS.pdf', w = 6, h = 3.5)
# par(mar = c(4,4,4,6), mgp = c(3,1,0), mfrow=c(1,1)) 
plot(diet$length, diet$dbonds, cex = diet$av.ko2*5+0.6, col = '#065c69', bg = alpha('#065c69', 0.5), pch = 21,
     main = '', ylab = 'Double bonds', xlab = 'Carbon chain length', 
     yaxt = 'n', xaxt = 'n', ylim = c(0.5,3.5), xlim = c(33.5, 43.5))
...
axis(1, seq(30,50,1))
axis(2,seq(0,6,1), las = 2)
legend('topright', legend = c('0.01','0.1',' 0.5'),col='#065c69',pt.bg = alpha('#065c69', 0.5),
       pch=21,pt.cex=c(0.01,0.1,0.5)*5+0.6,cex = 0.8,title = 'Concentration', xpd = TRUE, inset = c(-0.25,0), bty = 'n')
# dev.off()
...
### OVERLAY PLOT - CER class
pdf('Distribution_of_CER_class_DIET_AAV_OVERLAY.pdf', w = 12, h = 2.5)
# par(mar = c(4,4,4,6), mgp = c(3,1,0), mfrow=c(1,1)) 
...
# dev.off()
points(diet$length, diet$dbonds, cex = diet$av.ko1*0.5+0.6, col = '#663333', bg = alpha('#663333', 0.5), pch = 21)
...
# dev.off()
points(diet$length, diet$dbonds, cex = diet$av.ko2*0.5+0.6, col = '#065c69', bg = alpha('#065c69', 0.5), pch = 21)
...
# dev.off()
points(diet$length, diet$dbonds, cex = diet$av.ko1*5+0.6, col = '#663333', bg = alpha('#663333', 0.5), pch = 21)
points(diet$length, diet$dbonds, cex = diet$av.ko2*5+0.6, col = '#065c69', bg = alpha('#065c69', 0.5), pch = 21)
